...
public class Main {
    public static void main(String[] args) {
        ...
        items.put(new Item(3L, "Chorapi", 5.70D, Category.NON_FOOD, null), 10);
        ...
        try {
            invoiceFileIOUtil.write(invoice, shop.getId());
            invoiceFileIOUtil.write(invoice1, shop.getId());
            invoiceFileIOUtil.write(invoice2, shop.getId());
        ...
        deliveryService.delivery(items, shop);
